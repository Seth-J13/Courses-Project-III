...
**Depends on:** [Feature 3 — Course Management](feature-3-course-management.md)
...
**As a** signed-in user  
**I want to** see all of my courses listed on one screen  
**So that** I can see what courses I have signed up for

**Priority:** P1  
**Independent test:** CourseList loads a single list of owned courses (no sidebar split)  
